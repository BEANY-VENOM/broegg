...
const shopItems = [
  ...
  {
    name: "Shotgun",
    description: "Unlock the Shotgun",
    price: 70,
...
function syncWeapon() {
  ...
  player.bulletSpeed = weapon.bulletSpeed;
  player.bulletSize = weapon.bulletSize;
}
